...
for nc in ${NCS[@]}; do
    echo "rendering $nc"
    #pvbatch $renderscript oxyg 0 500 'Black, Blue and White' oxygen $nc
    #pvbatch $renderscript temp 10 35 Plasma temperature $nc
    pvbatch $renderscript salt 0 40 'Viridis (matplotlib)' salt $nc
done
